...
//equivalent of each digit into the integer array. For comparing HugeInteger objects, provide the following methods:
// isEqualTo, isNotEqualTo, isGreaterThan, isLessThan, isGreaterThanOrEqualTo
//and isLessThanOrEqualTo. Each of these is a predicate method that returns true if the relationship
//holds between the two HugeInteger objects and returns false if the relationship does not hold. Provide a predicate method isZero.
//If you feel ambitious, also provide methods multiply, divide and
